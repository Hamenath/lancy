...
const GlowCard: React.FC<GlowCardProps> = ({ 
  ...
  const getInlineStyles = () => {
    const baseStyles: React.CSSProperties & Record<string, any> = {
      '--base': base,
      '--spread': spread,
      '--radius': '0', // 0 radius for sharp corners
      '--border': '1.5', // Thinner, elegant border line
      '--backdrop': 'transparent', // Fully transparent to let glassmorphism handle background
